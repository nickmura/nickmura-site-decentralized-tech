...
>
	<a
		href="https://twitter.com/nickmura2"
	...
	>
	<a
		href="https://github.com/nickmura"
		class="fill-white w-16 transition duration-300 hover:fill-green-100"
	>
...
<section class="w-screen p-12 flex flex-col gap-4 items-center">
	...
	>
		<img src='./streamgift.png' class='w-20 rounded-xl' alt=''>
		<div class="w-full flex flex-col p-4">
			<h2 class="text-2xl font-bold">stream.gift</h2>
			<h3 class="text-xl text-gray-500">send crypto donations to livestreamers</h3>
		</div>
	</a>
	...
	class="h-max w-full md:max-w-[80%] border border-[rgba(255,255,255,0.125)] rounded-xl flex gap-4 p-4 items-center justify-start"
>
	<img src='./awpswap-greyscale.png' class='w-20 rounded-xl' alt=''>
	<div class="w-full flex flex-col p-4">
		<h2 class="text-2xl font-bold">AWPSwap.io</h2>
	...
	<a
		...
		class="h-max w-full md:max-w-[80%] border border-[rgba(255,255,255,0.125)] rounded-xl flex gap-4 p-4 items-center justify-start"
	>
		<p class='text-5xl w-20 pl-6'>r</p>

		<div class="w-full flex flex-col p-4">
			<h2 class="text-2xl font-bold">receive.me</h2>
			<h3 class="text-xl text-gray-500">web3 address/link profiles</h3>
		</div>
	</a>
